...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/yaqd-new-era-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12723&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/yaqd-new-era-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `yaqd-new-era` can be installed with:

```
conda install yaqd-new-era
```

It is possible to list all of the versions of `yaqd-new-era` available on your platform with:
